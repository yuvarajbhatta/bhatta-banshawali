...
- **Migration tests**: Flyway migration scripts tested against a representative data snapshot (from the staging environment established in `07-migration-plan.md`), including a dry run against production-shaped data before real cutover.
