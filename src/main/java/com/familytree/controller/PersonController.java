...
public class PersonController {
    ...
    @GetMapping("/persons")
    public String listPersons(@RequestParam(required = false) String keyword,
                              @RequestParam(required = false) Integer cleanupCount,
                              Model model) {
    ...
    @PostMapping("/persons/admin/cleanup-generated-nepali")
    public String cleanupGeneratedNepaliNames() {
        int updatedCount = personService.clearAutogeneratedNepaliNames();
        return "redirect:/persons?cleanupCount=" + updatedCount;
    }
...
//        }
    ...
    public ResponseEntity<Map<String, Object>> saveLineagePerson(@RequestParam String fullName,
        ...
        response.put("englishName", buildFullName(savedPerson.getFirstName(), savedPerson.getMiddleName(), savedPerson.getLastName()));
        response.put("nepaliName", buildFullName(savedPerson.getFirstNameNepali(), savedPerson.getMiddleNameNepali(), savedPerson.getLastNameNepali()));
        response.put("photoPath", savedPerson.getPhotoPath());
