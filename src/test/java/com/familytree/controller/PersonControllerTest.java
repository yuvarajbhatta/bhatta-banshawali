...
class PersonControllerTest {
    ...
    void listPersonsAddsResultsAndKeyword() {
        ...
        String viewName = controller.listPersons("yu", null, model);
    ...
    @Test
    void cleanupGeneratedNepaliNamesRedirectsWithUpdatedCount() {
        when(personService.clearAutogeneratedNepaliNames()).thenReturn(12);

        String viewName = controller.cleanupGeneratedNepaliNames();

        assertThat(viewName).isEqualTo("redirect:/persons?cleanupCount=12");
        verify(personService).clearAutogeneratedNepaliNames();
    }
